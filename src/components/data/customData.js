...
export const portfolio = [
  {
    ...
    description: {
      short:
        'Netflix clone/replica, built with React, Firebase, JavaScript, HTML5 and CSS3.',
      full:
  ...
  },
  {
    ...
    description: {
      ...
      full:
        "The idea behind this project was to create a showcase of my technical and design skills. I tried to keep the UI as simple as possible yet to make it attractive and stylish. For this project I've used ReactJs, Material UI components and React Router for navigation.",
    },
  ...
  },
  {
    ...
    description: {
      short:
        'E-commerce Website developed for Ozar, an online retailer in Ukraine, as Front-End Developer at GBC.',
      full:
  ...
  },
  {
    ...
    description: {
      short:
        'Website developed for a London based construction company as Contractor Front-End Developer.',
      full: '',
    },
  ...
  },
  {
    ...
    description: {
      ...
      full:
        'The challenge for me was to make it responsive since most pages contain large images so I needed to make sure the whole website looks good on any device.',
    },
  ...
  },
  {
    ...
    carouselImages: [
      '/images/nobletec/nobletec-1.jpg',
      '/images/nobletec/nobletec-2.jpg',
      '/images/nobletec/nobletec-3.jpg',
    ],
  ...
  },
  {
    ...
    description: {
      short:
        'Website developed for cTech in US as Freelance Front-End Developer.',
      full: '',
    },
    thumbnail: '/images/ctech/preview.jpg',
    thumbnailHover: '/images/ctech/preview-hover.jpg',
    carouselImages: [
      '/images/ctech/ctech-1.jpg',
      '/images/ctech/ctech-2.jpg',
      '/images/ctech/ctech-3.jpg',
    ],
    tags: ['WordPress', 'Html5', 'CSS3', 'JavaScript'],
    category: ['all', 'wordpress'],
    animation: {
  ...
  },
  {
    ...
    description: {
      short:
        'Website developed for a non-profit organisation in USA as Freelance Front-End Developer.',
      full: '',
    },
