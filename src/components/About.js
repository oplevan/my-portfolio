        ...
        <>
            ...
            <Box component='section' className='page__content'>
                <Container maxWidth="md" className='topContainer'>
                    <Typography variant='h3' className={classes.pageTitle}>About me</Typography>
                ...
                <Container maxWidth='lg' className={classes.bottomContainer}>
                    <Box component='div' className={classes.infoBox}>
                        ...
                        <Box component='div'>
                            <p>
                            I am a Front-End Web Developer based in London, UK. I have serious passion for UI effects, animations and creating intuitive, dynamic user experience. Well-organised person, problem solver, independent employee with high attention to detail. Interested in the entire frontend spectrum and working on ambitious projects with positive people. 
                            </p>
                            <p>
                            Also, I'm planing to extend my skill set to become a full stack developer in the near future.
                            </p>
                            <div>
                                <Typography variant='h6'>Random facts</Typography>
                                <ul>
                                    <li>I'm a big fan of MMA.</li>
                                    <li>I like lifting heavy things while listening to heavy metal, but usually listening to Blues or Jazz when coding.</li>
