...
export default function Contact() {
  ...
  return (
    <>
      <Container maxWidth="md" component="main" id="contact">
        <h1>Contact</h1>
        <Box component="div" className="greeting" align="left">
          <Typography variant="h4">Get in touch</Typography>
          <p>
            If you want to get in touch, talk to me about a project collaboration or just have a question, fill up the form below
            or send an email to{" "}
